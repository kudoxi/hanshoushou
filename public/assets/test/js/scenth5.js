...
! function(t) {
	...
	}, e.startEngine = lt, e.stopEngine = dt, e.stopAllActionGroups = mt, e.stopActionGroup = It, e.startActionGroup = Ot;
	var c = O(n(100)),
		s = O(n(38)),
		f = O(n(283)),
		l = O(n(289)),
					...
					! function(t) {
						if(rt) {
							...
							for(var r in t) {
								...
								e[u] || o !== b && o !== S || (e[u] = !0, n += u + "{cursor: pointer;touch-action: manipulation;}")
							}
							if(n) {
	...
	function mt(t) {
		...
		(0, v.default)(n, function(t) {
			if(!t.continuous) {
				var n = t.actionListId,
					r = t.verbose;
				bt(t, e), r && e.dispatch((0, g.actionListPlaybackChanged)({
					actionListId: n,
					isPlaying: !1
				}))
			}
	...
	function It(t) {
		...
		(0, v.default)(u, function(t) {
			...
			if(t.actionListId === o && t.eventId === n && a) {
				...
				bt(t, e), t.verbose && e.dispatch((0, g.actionListPlaybackChanged)({
					actionListId: o,
					isPlaying: !1
				}))
			}
	...
	function Tt(t) {
		...
		e.dispatch((0, g.instanceAdded)((0, a.default)({
			...
			t.dispatch((0, g.animationFrameChanged)(Number.POSITIVE_INFINITY, n)), At(t.getState().ixInstances[e], t)
		}(e, l) : (X({
			store: e,
			select: function(t) {
	...
	n(138), n(165), n(167), n(332), n(333), t.exports = n(334)
}, function(t, e, n) {
	"use strict";
	var r = n(17);
	...
	var r = n(5),
		...
		z = function(t, e, n) {
			return t === V && z(X, e, n), y(t), e = I(e, !0), y(n), i(G, e) ? (n.enumerable ? (i(t, P) && t[P][e] && (t[P][e] = !1), n = T(n, {
				enumerable: O(0, !1)
	...
	k || (u((N = function() {
		...
		var t = d(arguments.length > 0 ? arguments[0] : void 0),
			e = function(n) {
				this === V && e.call(X, n), i(this, P) && i(this[P], t) && (this[P][t] = !1), H(this, t, O(1, n))
			};
		return o && B && H(V, t, {
			configurable: !0,
			set: e
		...
		return this._k
	}), S.f = q, A.f = z, n(92).f = b.f = $, n(31).f = Q, n(54).f = Z, o && !n(28) && u(V, "propertyIsEnumerable", Q, !0), v.f = function(t) {
		return W(p(t))
	}), a(a.G + a.W + a.F * !k, {
		Symbol: N
	});
	...
	}), N.prototype[D] || n(13)(N.prototype, D, N.prototype.valueOf), l(N, "Symbol"), l(Math, "Math", !0), l(r.JSON, "JSON", !0)
}, function(t, e, n) {
	var r = n(30)("meta"),
		i = n(20),
		o = n(9),
					...
					switch(u) {
						...
						case g.STYLE_TEXT_COLOR:
							var y = T[u],
								...
								b = n.aValue;
							k(t, y, o), a(t, y, b >= 1 ? "rgb(" + m + "," + I + "," + O + ")" : "rgba(" + m + "," + I + "," + O + "," + b + ")");
							break;
						default:
							var S = c.unit,
								A = void 0 === S ? "" : S;
	...
	var O = function(t) {
		...
		T = Object.freeze((r = {}, (0, u.default)(r, g.STYLE_BACKGROUND_COLOR, _.BACKGROUND_COLOR), (0, u.default)(r, g.STYLE_BORDER, _.BORDER_COLOR), (0, u.default)(r, g.STYLE_TEXT_COLOR, _.COLOR), r)),
		b = Object.freeze((i = {}, (0, u.default)(i, m.TRANSFORM_PREFIXED, _.TRANSFORM), (0, u.default)(i, _.BACKGROUND_COLOR, _.BACKGROUND), (0, u.default)(i, _.OPACITY, _.OPACITY), (0, u.default)(i, _.FILTER, _.FILTER), (0, u.default)(i, _.WIDTH, _.WIDTH), (0, u.default)(i, _.HEIGHT, _.HEIGHT), i)),
		S = {},
		A = 1;
	var w = 1;
	var R = function(t, e) {
	...
	function L(t) {
		...
		if(L ? (N = R.limitAffectedElements, C = P, M = u(R)) : C = M = u({
			...
			var D = r && (M || !0 === A) ? [r] : c(P);
			if(M) {
				if(A === _.PARENT) return c(M).filter(function(t) {
					return D.some(function(e) {
						return p(t, e)
					})
				});
				if(A === _.CHILDREN) return c(M).filter(function(t) {
					return D.some(function(e) {
						return p(e, t)
					})
				});
				if(A === _.SIBLINGS) return c(M).filter(function(t) {
					return D.some(function(e) {
						return v(e, t)
					})
				})
		...
		if(m.IS_BROWSER_ENV) {
			...
			if(r) {
				var i = n.getStyle,
					...
					a = i(t, _.WILL_CHANGE);
				if(a) {
					var u = a.split(_.COMMA_DELIMITER).map(O); - 1 === u.indexOf(r) && o(t, _.WILL_CHANGE, u.concat(r).join(_.COMMA_DELIMITER))
		...
		if(m.IS_BROWSER_ENV) {
			...
			if(r) {
				var i = n.getStyle,
					o = n.setStyle,
					a = i(t, _.WILL_CHANGE);
				a && -1 !== a.indexOf(r) && o(t, _.WILL_CHANGE, a.split(_.COMMA_DELIMITER).map(O).filter(function(t) {
					return t !== r
	...
	e.ixSession = function() {
		...
		switch(e.type) {
			...
			case d:
				for(var m = e.payload, I = m.width, O = m.mediaQueries, T = O.length, b = null, S = 0; S < T; S++) {
					var A = O[S],
						w = A.key,
						R = A.min,
						x = A.max;
	...
	var r = n(2),
		...
		m = function(t, e) {
			...
			for(var I = void 0, O = void 0, T = void 0, b = void 0, S = 0, A = o.length; S < A; S++) {
				var w = o[S],
					R = w.keyframe,
					x = w.actionItems;
				if(0 === S && (I = x[0]), m >= R) {
			...
			if(I && !O)
				for(var M = 0, P = a.length; M < P; M++) {
					...
					for(var j = (g - T) / b, F = I.config.easing, G = v(F, j), X = 0, V = a.length; X < V; X++) {
						var k = a[X],
		...
		I = function(t, e) {
			...
			if(r && o) {
				...
				return d.length && (R = d.reduce(function(t, e) {
					...
					return t[e] = i, t
				}, {})), w.current = R, w.position = S, 1 === S && (w.active = !1, w.complete = !0), (0, i.merge)(t, w)
			}
			return t
		};
	...
	var h, E, _, y = p.IX2EngineEventTypes,
		g = y.MOUSE_CLICK,
	...
	e.default = (r = {}, (0, i.default)(r, w, Et()), (0, i.default)(r, R, _t()), (0, i.default)(r, A, Et()), (0, i.default)(r, S, _t()), (0, i.default)(r, C, Et(!1)), (0, i.default)(r, N, _t(!1)), (0, i.default)(r, x, Et()), (0, i.default)(r, L, _t()), (0, i.default)(r, B, {
		...
		types: "mousedown"
	})), (0, i.default)(r, O, (0, u.default)({}, it, {
		types: "mouseup"
	})), (0, i.default)(r, T, {
		...
		handler: function(t) {
			...
			switch(u) {
				case z:
					b = O ? Math.min(h, window.innerWidth) / window.innerWidth : Math.min(_, window.innerHeight) / window.innerHeight;
					break;
				case K:
					var w = st(),
						R = w.scrollLeft,
			...
			return T && (b > .95 || b < .05) && (b = Math.round(b)), (u !== Y || A || A !== a.elementHovered) && (b = f ? 1 - b : b, e.dispatch((0, d.parameterChanged)(S, b))), {
				elementHovered: A,
				clientX: h,
				clientY: _,
				pageX: g,
		...
		handler: function(t) {
			...
			if(p === z) {
				...
				return b !== o.scrollPercent && n.dispatch((0, d.parameterChanged)(h, b)), {
					scrollPercent: b
				}
			}
			var S = q(i, h),
				...
				R = (y ? T : 0) / 100;
			w = E ? w : 1 - w, R = _ ? R : 1 - R;
			var x = A.top + Math.min(A.height * w, l),
				L = A.top + A.height * R - x,
				N = Math.min(l + L, f),
	...
	"use strict";
	n(17).define("touch", t.exports = function(t) {
		var e = {},
...
Webflow.require('ix2').init({
	...
	"actionLists": {
		"a": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"locked": false,
						"target": {
							"id": "5ce4ca4ea62d23d7136f6475|c05d6f44-d447-d032-ae4e-797a73636885"
						},
						"widthValue": 1,
						"widthUnit": "PX",
						"heightUnit": "PX"
			...
			"createdOn": 1558502254878,
			"useFirstGroupAsInitialState": false
		},
		"a-2": {
			"id": "a-2",
			"title": "start-button up",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-2-n",
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce4bd78a62d237e2c6f3e38|d2eb6853-47e8-abac-ec5f-92b4d1e0f4ef"
						},
						"yValue": 117,
						"xUnit": "PX",
						"yUnit": "PX",
			...
			"createdOn": 1558504727583,
			"useFirstGroupAsInitialState": true
		},
		"a-3": {
			"id": "a-3",
			"title": "start-button up 2",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-3-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce4f5e9b7568ae2b12b3451|d2eb6853-47e8-abac-ec5f-92b4d1e0f4ef"
						},
						"yValue": 117,
						"xUnit": "PX",
						"yUnit": "PX",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce508cd895580010925cba7|d2eb6853-47e8-abac-ec5f-92b4d1e0f4ef"
						},
						"yValue": 117,
						"xUnit": "PX",
						"yUnit": "PX",
		...
		"a-5": {
			"id": "a-5",
			"title": "loading to index",
			"actionItemGroups": [],
			"createdOn": 1558521406939,
			"useFirstGroupAsInitialState": false
		},
		"a-6": {
			"id": "a-6",
			"title": "start-button up 4",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-6-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|d2eb6853-47e8-abac-ec5f-92b4d1e0f4ef"
						},
						"yValue": 117,
						"xUnit": "PX",
						"yUnit": "PX",
		...
		"a-7": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|e8f7c184-2515-ddd0-1822-63bf44c701a1"
						},
						"yValue": -90,
						"xUnit": "PX",
						"yUnit": "PX",
			...
			"createdOn": 1558582083673,
			"useFirstGroupAsInitialState": true
		},
		"a-9": {
			"id": "a-9",
			"title": "jianjian chuxian",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-9-n",
					"actionTypeId": "STYLE_OPACITY",
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|41e02b5f-b1dd-6d17-408f-3700600ab9e8"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|1322c964-53d6-8c97-1def-f3901364a60b"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|5b734474-3e73-22ba-564d-4c0fbfabb1ac"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|d29bd247-7392-9004-cc05-b4fbf73efb4a"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|4e9819b6-68b0-b81c-1cd1-92ef4355f244"
						},
						"value": 0,
						"unit": ""
					}
					...
					"config": {
						...
						"duration": 500,
						"target": {
							"id": "5ce5fb72d355ee2af9e08354|5004a6bf-dc8c-8a38-412c-ae0f6c6638b8"
						},
						"value": 0,
						"unit": ""
					}
