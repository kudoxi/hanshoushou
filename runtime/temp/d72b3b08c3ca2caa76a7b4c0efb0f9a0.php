<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:110:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/public/../application/hanshou/view/base/add_language.html";i:1521373494;s:94:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/application/hanshou/view/public/head.html";i:1521373495;s:96:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/application/hanshou/view/public/header.html";i:1521373495;s:97:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/application/hanshou/view/public/sidebar.html";i:1521373495;s:96:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/application/hanshou/view/public/footer.html";i:1521373495;s:94:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/application/hanshou/view/public/foot.html";i:1521373495;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			...
			<div class="content-wrapper" style="min-height: 1020px;">
				<div class="box">
					<div class="box-header with-border" style="padding-left: 50px;">
						<h3 class="box-title">创建一个新的语言分类吧</h3>
					</div>
					<div class="box-body content" style="padding: 20px 50px;">
						<div class="input-group" style="margin-bottom: 20px;">
							<input type="text" name="name" class="form-control name" value="" placeholder="新的语言分类"/>
							<span class="input-group-btn">
				        		<button class="btn btn-primary btn-flat add_language">创建</button>
				      		</span>
						</div>
					</div>
				</div>
...
<script>
	...
	<script>
		$(".add_language").click(function(){
			...
			$.ajax({
				type:"post",
				url:"<?php echo url('hanshou/base/add_language'); ?>",
				async:false,
				data:{name:name},
				success:function(data){
					if(data[0]== "101"){
					...
					layer.msg(data[1], {icon: $msg,}, function(){
					  window.location.href="<?php echo url('hanshou/base/upload'); ?>";//do something
					});           
				}
			});
		})
