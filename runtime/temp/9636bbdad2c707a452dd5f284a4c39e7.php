<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:83:"D:\UPUPW_AP7.0\htdocs\hanshou\public/../application/hanshou\view\record\record.html";i:1571016992;s:71:"D:\UPUPW_AP7.0\htdocs\hanshou\application\hanshou\view\public\head.html";i:1571016990;s:73:"D:\UPUPW_AP7.0\htdocs\hanshou\application\hanshou\view\public\header.html";i:1571016991;s:74:"D:\UPUPW_AP7.0\htdocs\hanshou\application\hanshou\view\public\sidebar.html";i:1571016990;s:73:"D:\UPUPW_AP7.0\htdocs\hanshou\application\hanshou\view\public\footer.html";i:1571016991;s:71:"D:\UPUPW_AP7.0\htdocs\hanshou\application\hanshou\view\public\foot.html";i:1571016991;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
							...
							<div class="row">
								...
								<ul class="list-group">
									...
									<li class="list-group-item">
										...
										<div>
											<audio src="<?php echo $vo['url']; ?>" controls="controls" class="audio_" muted></audio>
										</div>
...
<script>
	...
	<script>
		$(function(){
			var k = 0;
			$(".audio_").each(function(){
				if(k == 0){
					console.log("k:"+k);
					console.log("a:"+$(this).prop("muted"));
					var mu = setTimeout(function(){
						$(this).prop('muted',false);
					},3000);
					console.log("b:"+$(this).prop("muted"));
				}
				k++;
			})
		})
