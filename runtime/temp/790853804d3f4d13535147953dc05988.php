		...
		<div class="content-wrapper" style="min-height: 1020px;">
			<div class="box">
				<div class="box-header with-border" style="padding-left: 50px;">
					<h3 class="box-title"><?php echo $language; ?>单词部分</h3>
				</div>
						...
						<div class="row">
							...
							<ul class="list-group">
								...
								<li class="list-group-item">
									...
									<div>
										<a href="<?php echo $vo['url']; ?>" download="<?php echo $vo['name']; ?>" target="_blank">下载</a>
									</div>
									<?php endif; ?>
