<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:108:"/data3/htdocs/hanshoushou.host.smartgslb.com/hanshou/public/../application/common/view/tpl/dispatch_jump.tpl";i:1521373493;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="system-message <?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>">
            <div class="image">
                <img src="/hanshou/public/assets/img/<?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo($msg);?></h1>
            <p class="jump">
