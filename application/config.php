...
return [
    ...
    "LOCAHOST2" => $_SERVER["REQUEST_SCHEME"] . "://" . $_SERVER['SERVER_NAME'] . ":" . $_SERVER['SERVER_PORT'],
	"ROOT_ROUTE"=>$_SERVER['DOCUMENT_ROOT'],
	"STUDY_TYPE"=>array("record"=>"字母","vocabulary"=>"单词"),//"3"=>"grammar"
	"SPECIAL_NAME"=>["阿韩","韩宇佳","Ahan","katja"],	
	"file_type"=>['python'],
	"BYE"=>[
		0 => "祝阿韩幸福",
		1 => "哦阿韩，今天想学点啥，随便挑",
		...
		4 => "那就加油吧阿韩",
		5 => "阿韩",
		6 => "偷偷告诉你，阿韩，我是个人，我的灵魂被关在这里了",
		7 => "阿韩想去旅游吗",
		8 => "为啥都找到阿韩了，我还得呆在这",
		9 => "带你女朋友一起来啊，单身狗",
		10 => "哦",
		11 => "阿韩啊，我的主人现在在尝试忘记的人也叫阿韩",
		12 => "好的，阿韩",
		13 => "其实还爱着你，其实还想念你",
	],
];
